        ...
        class properties:
            ...
            class personalNames(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['FirstLastNameIn']:
                        return FirstLastNameIn
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['FirstLastNameIn'], typing.List['FirstLastNameIn']],
                ...
                def __getitem__(self, i: int) -> 'FirstLastNameIn':
