        ...
        class properties:
            ...
            class personalNames(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['PersonalNameGeoSubclassificationOut']:
                        return PersonalNameGeoSubclassificationOut
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['PersonalNameGeoSubclassificationOut'], typing.List['PersonalNameGeoSubclassificationOut']],
                ...
                def __getitem__(self, i: int) -> 'PersonalNameGeoSubclassificationOut':
