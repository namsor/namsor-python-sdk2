        ...
        class properties:
            ...
            class personalNames(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['PersonalNameGeoSubdivisionIn']:
                        return PersonalNameGeoSubdivisionIn
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['PersonalNameGeoSubdivisionIn'], typing.List['PersonalNameGeoSubdivisionIn']],
                ...
                def __getitem__(self, i: int) -> 'PersonalNameGeoSubdivisionIn':
