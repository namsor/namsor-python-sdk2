        ...
        class properties:
            ...
            class personalNames(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['FirstLastNameGeoSubclassificationOut']:
                        return FirstLastNameGeoSubclassificationOut
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['FirstLastNameGeoSubclassificationOut'], typing.List['FirstLastNameGeoSubclassificationOut']],
                ...
                def __getitem__(self, i: int) -> 'FirstLastNameGeoSubclassificationOut':
