        ...
        class properties:
            ...
            class personalNames(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['PersonalNameCastegroupOut']:
                        return PersonalNameCastegroupOut
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['PersonalNameCastegroupOut'], typing.List['PersonalNameCastegroupOut']],
                ...
                def __getitem__(self, i: int) -> 'PersonalNameCastegroupOut':
