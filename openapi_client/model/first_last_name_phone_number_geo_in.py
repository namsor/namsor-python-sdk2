...
class FirstLastNamePhoneNumberGeoIn(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            countryIso2Alt = schemas.StrSchema
            __annotations__ = {
                "id": id,
                "firstName": firstName,
                "lastName": lastName,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["countryIso2Alt"]) -> MetaOapg.properties.countryIso2Alt: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "firstName", "lastName", "phoneNumber", "countryIso2", "countryIso2Alt", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["countryIso2Alt"]) -> typing.Union[MetaOapg.properties.countryIso2Alt, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "firstName", "lastName", "phoneNumber", "countryIso2", "countryIso2Alt", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        countryIso2Alt: typing.Union[MetaOapg.properties.countryIso2Alt, str, schemas.Unset] = schemas.unset,
