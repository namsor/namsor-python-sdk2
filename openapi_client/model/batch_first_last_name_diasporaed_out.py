        ...
        class properties:
            ...
            class personalNames(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['FirstLastNameDiasporaedOut']:
                        return FirstLastNameDiasporaedOut
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['FirstLastNameDiasporaedOut'], typing.List['FirstLastNameDiasporaedOut']],
                ...
                def __getitem__(self, i: int) -> 'FirstLastNameDiasporaedOut':
