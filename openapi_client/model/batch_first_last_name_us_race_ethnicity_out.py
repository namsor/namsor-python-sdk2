        ...
        class properties:
            ...
            class personalNames(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['FirstLastNameUSRaceEthnicityOut']:
                        return FirstLastNameUSRaceEthnicityOut
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['FirstLastNameUSRaceEthnicityOut'], typing.List['FirstLastNameUSRaceEthnicityOut']],
                ...
                def __getitem__(self, i: int) -> 'FirstLastNameUSRaceEthnicityOut':
