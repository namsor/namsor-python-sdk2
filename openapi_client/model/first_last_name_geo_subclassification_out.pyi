...
class FirstLastNameGeoSubclassificationOut(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["script", "id", "explanation", "firstName", "lastName", "countryIso2", "subClassification", "subClassificationAlt", "subclassificationTop", "score", "probabilityCalibrated", "probabilityAltCalibrated", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["script", "id", "explanation", "firstName", "lastName", "countryIso2", "subClassification", "subClassificationAlt", "subclassificationTop", "score", "probabilityCalibrated", "probabilityAltCalibrated", ], str]):
