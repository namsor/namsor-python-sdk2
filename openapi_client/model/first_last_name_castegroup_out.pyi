...
class FirstLastNameCastegroupOut(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["script", "id", "explanation", "firstName", "lastName", "castegroup", "castegroupAlt", "castegroupTop", "score", "probabilityCalibrated", "probabilityAltCalibrated", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["script", "id", "explanation", "firstName", "lastName", "castegroup", "castegroupAlt", "castegroupTop", "score", "probabilityCalibrated", "probabilityAltCalibrated", ], str]):
