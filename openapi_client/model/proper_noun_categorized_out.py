...
class ProperNounCategorizedOut(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            commonType = schemas.StrSchema
            commonTypeAlt = schemas.StrSchema
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["commonType"]) -> MetaOapg.properties.commonType: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["commonTypeAlt"]) -> MetaOapg.properties.commonTypeAlt: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["script", "id", "explanation", "name", "commonType", "commonTypeAlt", "score", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["commonType"]) -> typing.Union[MetaOapg.properties.commonType, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["commonTypeAlt"]) -> typing.Union[MetaOapg.properties.commonTypeAlt, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["script", "id", "explanation", "name", "commonType", "commonTypeAlt", "score", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        commonType: typing.Union[MetaOapg.properties.commonType, str, schemas.Unset] = schemas.unset,
        commonTypeAlt: typing.Union[MetaOapg.properties.commonTypeAlt, str, schemas.Unset] = schemas.unset,
