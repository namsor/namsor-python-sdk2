        ...
        class properties:
            ...
            class personalNames(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['MatchPersonalFirstLastNameIn']:
                        return MatchPersonalFirstLastNameIn
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['MatchPersonalFirstLastNameIn'], typing.List['MatchPersonalFirstLastNameIn']],
                ...
                def __getitem__(self, i: int) -> 'MatchPersonalFirstLastNameIn':
