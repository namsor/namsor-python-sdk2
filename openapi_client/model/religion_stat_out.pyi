...
class ReligionStatOut(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["religion", "pct", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["religion", "pct", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        pct: typing.Union[MetaOapg.properties.pct, decimal.Decimal, int, float, schemas.Unset] = schemas.unset,
