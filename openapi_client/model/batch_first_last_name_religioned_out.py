...
class BatchFirstLastNameReligionedOut(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class personalNames(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['FirstLastNameReligionedOut']:
                        return FirstLastNameReligionedOut
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['FirstLastNameReligionedOut'], typing.List['FirstLastNameReligionedOut']],
                ...
                def __getitem__(self, i: int) -> 'FirstLastNameReligionedOut':
