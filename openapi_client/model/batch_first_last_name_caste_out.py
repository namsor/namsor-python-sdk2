...
class BatchFirstLastNameCasteOut(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class personalNames(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['FirstLastNameCasteOut']:
                        return FirstLastNameCasteOut
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['FirstLastNameCasteOut'], typing.List['FirstLastNameCasteOut']],
                ...
                def __getitem__(self, i: int) -> 'FirstLastNameCasteOut':
