        ...
        class properties:
            ...
            class personalNames(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['PersonalNameGeoIn']:
                        return PersonalNameGeoIn
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['PersonalNameGeoIn'], typing.List['PersonalNameGeoIn']],
                ...
                def __getitem__(self, i: int) -> 'PersonalNameGeoIn':
