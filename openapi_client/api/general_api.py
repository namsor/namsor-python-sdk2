...
class GeneralApi(object):
    ...
    def name_type1(self, proper_noun, country_iso2, **kwargs):  # noqa: E501
        """Infer the likely type of a proper noun (personal name, brand name, place name etc.)  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.name_type1(proper_noun, country_iso2, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.name_type1_with_http_info(proper_noun, country_iso2, **kwargs)  # noqa: E501
        else:
            (data) = self.name_type1_with_http_info(proper_noun, country_iso2, **kwargs)  # noqa: E501
            return data

    def name_type1_with_http_info(self, proper_noun, country_iso2, **kwargs):  # noqa: E501
        """Infer the likely type of a proper noun (personal name, brand name, place name etc.)  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.name_type1_with_http_info(proper_noun, country_iso2, async_req=True)
        >>> result = thread.get()
        ...
        if ('proper_noun' not in local_var_params or
                local_var_params['proper_noun'] is None):
            raise ValueError("Missing the required parameter `proper_noun` when calling `name_type1`")  # noqa: E501
        ...
        if ('country_iso2' not in local_var_params or
            ...
            raise ValueError("Missing the required parameter `country_iso2` when calling `name_type1`")  # noqa: E501
