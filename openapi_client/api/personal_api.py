...
class PersonalApi(object):
    ...
    def corridor(self, country_iso2_from, first_name_from, last_name_from, country_iso2_to, first_name_to, last_name_to, **kwargs):  # noqa: E501
        ...
        >>> thread = api.corridor(country_iso2_from, first_name_from, last_name_from, country_iso2_to, first_name_to, last_name_to, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str country_iso2_from: (required)
        :param str first_name_from: (required)
        :param str last_name_from: (required)
        :param str country_iso2_to: (required)
        :param str first_name_to: (required)
        :param str last_name_to: (required)
        :return: CorridorOut
        ...
        if kwargs.get('async_req'):
            return self.corridor_with_http_info(country_iso2_from, first_name_from, last_name_from, country_iso2_to, first_name_to, last_name_to, **kwargs)  # noqa: E501
        else:
            (data) = self.corridor_with_http_info(country_iso2_from, first_name_from, last_name_from, country_iso2_to, first_name_to, last_name_to, **kwargs)  # noqa: E501
            return data

    def corridor_with_http_info(self, country_iso2_from, first_name_from, last_name_from, country_iso2_to, first_name_to, last_name_to, **kwargs):  # noqa: E501
        """[USES 20 UNITS PER NAME COUPLE] Infer several classifications for a cross border interaction between names (ex. remit, travel, intl com)  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.corridor_with_http_info(country_iso2_from, first_name_from, last_name_from, country_iso2_to, first_name_to, last_name_to, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['country_iso2_from', 'first_name_from', 'last_name_from', 'country_iso2_to', 'first_name_to', 'last_name_to']  # noqa: E501
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method corridor" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'country_iso2_from' is set
        if ('country_iso2_from' not in local_var_params or
                local_var_params['country_iso2_from'] is None):
            raise ValueError("Missing the required parameter `country_iso2_from` when calling `corridor`")  # noqa: E501
        # verify the required parameter 'first_name_from' is set
        if ('first_name_from' not in local_var_params or
                local_var_params['first_name_from'] is None):
            raise ValueError("Missing the required parameter `first_name_from` when calling `corridor`")  # noqa: E501
        # verify the required parameter 'last_name_from' is set
        if ('last_name_from' not in local_var_params or
                local_var_params['last_name_from'] is None):
            raise ValueError("Missing the required parameter `last_name_from` when calling `corridor`")  # noqa: E501
        # verify the required parameter 'country_iso2_to' is set
        if ('country_iso2_to' not in local_var_params or
                local_var_params['country_iso2_to'] is None):
            raise ValueError("Missing the required parameter `country_iso2_to` when calling `corridor`")  # noqa: E501
        # verify the required parameter 'first_name_to' is set
        if ('first_name_to' not in local_var_params or
                local_var_params['first_name_to'] is None):
            raise ValueError("Missing the required parameter `first_name_to` when calling `corridor`")  # noqa: E501
        # verify the required parameter 'last_name_to' is set
        if ('last_name_to' not in local_var_params or
                local_var_params['last_name_to'] is None):
            raise ValueError("Missing the required parameter `last_name_to` when calling `corridor`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'country_iso2_from' in local_var_params:
            path_params['countryIso2From'] = local_var_params['country_iso2_from']  # noqa: E501
        if 'first_name_from' in local_var_params:
            path_params['firstNameFrom'] = local_var_params['first_name_from']  # noqa: E501
        if 'last_name_from' in local_var_params:
            path_params['lastNameFrom'] = local_var_params['last_name_from']  # noqa: E501
        if 'country_iso2_to' in local_var_params:
            path_params['countryIso2To'] = local_var_params['country_iso2_to']  # noqa: E501
        if 'first_name_to' in local_var_params:
            path_params['firstNameTo'] = local_var_params['first_name_to']  # noqa: E501
        if 'last_name_to' in local_var_params:
            path_params['lastNameTo'] = local_var_params['last_name_to']  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='CorridorOut',  # noqa: E501
    ...
    def corridor_batch(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.corridor_batch(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param BatchCorridorIn batch_corridor_in: A list of name pairs, with country code (nameFrom -> nameTo).
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.corridor_batch_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.corridor_batch_with_http_info(**kwargs)  # noqa: E501
            return data

    def corridor_batch_with_http_info(self, **kwargs):  # noqa: E501
        """[USES 20 UNITS PER NAME PAIR] Infer several classifications for up to 100 cross border interaction between names (ex. remit, travel, intl com)  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.corridor_batch_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['batch_corridor_in']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        body_params = None
        if 'batch_corridor_in' in local_var_params:
            body_params = local_var_params['batch_corridor_in']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='BatchCorridorOut',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
    ...
    def gender1(self, first_name, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.gender1(first_name, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.gender1_with_http_info(first_name, **kwargs)  # noqa: E501
        else:
            (data) = self.gender1_with_http_info(first_name, **kwargs)  # noqa: E501
            return data

    def gender1_with_http_info(self, first_name, **kwargs):  # noqa: E501
        """Infer the likely gender of a just a fiven name, assuming default 'US' local context. Please use preferably full names and local geographic context for better accuracy.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.gender1_with_http_info(first_name, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['first_name']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('first_name' not in local_var_params or
                local_var_params['first_name'] is None):
            raise ValueError("Missing the required parameter `first_name` when calling `gender1`")  # noqa: E501
    ...
    def religion_full(self, country_iso2, sub_division_iso31662, personal_name_full, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.religion_full(country_iso2, sub_division_iso31662, personal_name_full, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.religion_full_with_http_info(country_iso2, sub_division_iso31662, personal_name_full, **kwargs)  # noqa: E501
        else:
            (data) = self.religion_full_with_http_info(country_iso2, sub_division_iso31662, personal_name_full, **kwargs)  # noqa: E501
            return data

    def religion_full_with_http_info(self, country_iso2, sub_division_iso31662, personal_name_full, **kwargs):  # noqa: E501
        """[USES 10 UNITS PER NAME] Infer the likely religion of a personal full name. NB: only for INDIA (as of current version).  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.religion_full_with_http_info(country_iso2, sub_division_iso31662, personal_name_full, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['country_iso2', 'sub_division_iso31662', 'personal_name_full']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('country_iso2' not in local_var_params or
                local_var_params['country_iso2'] is None):
            raise ValueError("Missing the required parameter `country_iso2` when calling `religion_full`")  # noqa: E501
        ...
        if ('sub_division_iso31662' not in local_var_params or
            ...
            raise ValueError("Missing the required parameter `sub_division_iso31662` when calling `religion_full`")  # noqa: E501
        # verify the required parameter 'personal_name_full' is set
        if ('personal_name_full' not in local_var_params or
                local_var_params['personal_name_full'] is None):
            raise ValueError("Missing the required parameter `personal_name_full` when calling `religion_full`")  # noqa: E501
    ...
    def religion_full_batch(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.religion_full_batch(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param BatchPersonalNameGeoSubdivisionIn batch_personal_name_geo_subdivision_in: A list of personal names
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.religion_full_batch_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.religion_full_batch_with_http_info(**kwargs)  # noqa: E501
            return data

    def religion_full_batch_with_http_info(self, **kwargs):  # noqa: E501
        """[USES 10 UNITS PER NAME] Infer the likely religion of up to 100 personal full names. NB: only for India as of currently.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.religion_full_batch_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['batch_personal_name_geo_subdivision_in']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method religion_full_batch" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        body_params = None
        if 'batch_personal_name_geo_subdivision_in' in local_var_params:
            body_params = local_var_params['batch_personal_name_geo_subdivision_in']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
    ...
    def subclassification(self, country_iso2, first_name, last_name, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.subclassification(country_iso2, first_name, last_name, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.subclassification_with_http_info(country_iso2, first_name, last_name, **kwargs)  # noqa: E501
        else:
            (data) = self.subclassification_with_http_info(country_iso2, first_name, last_name, **kwargs)  # noqa: E501
            return data

    def subclassification_with_http_info(self, country_iso2, first_name, last_name, **kwargs):  # noqa: E501
        """[USES 10 UNITS PER NAME] Infer the likely origin of a name at a country subclassification level (state or regeion). Initially, this is only supported for India (ISO2 code 'IN').  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.subclassification_with_http_info(country_iso2, first_name, last_name, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method subclassification" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'country_iso2' is set
        if ('country_iso2' not in local_var_params or
                local_var_params['country_iso2'] is None):
            raise ValueError("Missing the required parameter `country_iso2` when calling `subclassification`")  # noqa: E501
        # verify the required parameter 'first_name' is set
        if ('first_name' not in local_var_params or
                local_var_params['first_name'] is None):
            raise ValueError("Missing the required parameter `first_name` when calling `subclassification`")  # noqa: E501
        # verify the required parameter 'last_name' is set
        if ('last_name' not in local_var_params or
                local_var_params['last_name'] is None):
            raise ValueError("Missing the required parameter `last_name` when calling `subclassification`")  # noqa: E501
    ...
    def subclassification_batch(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.subclassification_batch(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.subclassification_batch_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.subclassification_batch_with_http_info(**kwargs)  # noqa: E501
            return data

    def subclassification_batch_with_http_info(self, **kwargs):  # noqa: E501
        """[USES 10 UNITS PER NAME] Infer the likely origin of a list of up to 100 names at a country subclassification level (state or regeion). Initially, this is only supported for India (ISO2 code 'IN').  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.subclassification_batch_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method subclassification_batch" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
    ...
    def subclassification_full(self, country_iso2, full_name, **kwargs):  # noqa: E501
        """[USES 10 UNITS PER NAME] Infer the likely origin of a name at a country subclassification level (state or regeion). Initially, this is only supported for India (ISO2 code 'IN').  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.subclassification_full(country_iso2, full_name, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.subclassification_full_with_http_info(country_iso2, full_name, **kwargs)  # noqa: E501
        else:
            (data) = self.subclassification_full_with_http_info(country_iso2, full_name, **kwargs)  # noqa: E501
            return data

    def subclassification_full_with_http_info(self, country_iso2, full_name, **kwargs):  # noqa: E501
        """[USES 10 UNITS PER NAME] Infer the likely origin of a name at a country subclassification level (state or regeion). Initially, this is only supported for India (ISO2 code 'IN').  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.subclassification_full_with_http_info(country_iso2, full_name, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['country_iso2', 'full_name']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method subclassification_full" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'country_iso2' is set
        if ('country_iso2' not in local_var_params or
                local_var_params['country_iso2'] is None):
            raise ValueError("Missing the required parameter `country_iso2` when calling `subclassification_full`")  # noqa: E501
        # verify the required parameter 'full_name' is set
        if ('full_name' not in local_var_params or
                local_var_params['full_name'] is None):
            raise ValueError("Missing the required parameter `full_name` when calling `subclassification_full`")  # noqa: E501
    ...
    def subclassification_full_batch(self, **kwargs):  # noqa: E501
        """[USES 10 UNITS PER NAME] Infer the likely origin of a list of up to 100 names at a country subclassification level (state or regeion). Initially, this is only supported for India (ISO2 code 'IN').  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.subclassification_full_batch(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.subclassification_full_batch_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.subclassification_full_batch_with_http_info(**kwargs)  # noqa: E501
            return data

    def subclassification_full_batch_with_http_info(self, **kwargs):  # noqa: E501
        """[USES 10 UNITS PER NAME] Infer the likely origin of a list of up to 100 names at a country subclassification level (state or regeion). Initially, this is only supported for India (ISO2 code 'IN').  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.subclassification_full_batch_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method subclassification_full_batch" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
