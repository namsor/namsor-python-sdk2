...
class JapaneseApi(object):
    ...
    def japanese_name_gender_kanji_candidates_batch(self, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param BatchFirstLastNameIn batch_first_last_name_in: A list of personal japanese names in LATIN, firstName = japaneseGivenName; lastName=japaneseSurname and known gender
