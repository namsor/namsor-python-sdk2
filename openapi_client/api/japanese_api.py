...
class JapaneseApi(object):
    ...
    def japanese_name_gender_kanji_candidates_batch(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.japanese_name_gender_kanji_candidates_batch(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param BatchFirstLastNameGenderIn batch_first_last_name_gender_in: A list of personal japanese names in LATIN, firstName = japaneseGivenName; lastName=japaneseSurname and known gender
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.japanese_name_gender_kanji_candidates_batch_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.japanese_name_gender_kanji_candidates_batch_with_http_info(**kwargs)  # noqa: E501
            return data

    def japanese_name_gender_kanji_candidates_batch_with_http_info(self, **kwargs):  # noqa: E501
        """Identify japanese name candidates in KANJI, based on the romanized name (firstName = japaneseGivenName; lastName=japaneseSurname) with KNOWN gender, ex. Yamamoto Sanae  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.japanese_name_gender_kanji_candidates_batch_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['batch_first_last_name_gender_in']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method japanese_name_gender_kanji_candidates_batch" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        body_params = None
        if 'batch_first_last_name_gender_in' in local_var_params:
            body_params = local_var_params['batch_first_last_name_gender_in']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
    ...
    def japanese_name_kanji_candidates(self, japanese_surname_latin, japanese_given_name_latin, known_gender, **kwargs):  # noqa: E501
        """Identify japanese name candidates in KANJI, based on the romanized name ex. Yamamoto Sanae - and a known gender.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.japanese_name_kanji_candidates(japanese_surname_latin, japanese_given_name_latin, known_gender, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.japanese_name_kanji_candidates_with_http_info(japanese_surname_latin, japanese_given_name_latin, known_gender, **kwargs)  # noqa: E501
        else:
            (data) = self.japanese_name_kanji_candidates_with_http_info(japanese_surname_latin, japanese_given_name_latin, known_gender, **kwargs)  # noqa: E501
            return data

    def japanese_name_kanji_candidates_with_http_info(self, japanese_surname_latin, japanese_given_name_latin, known_gender, **kwargs):  # noqa: E501
        """Identify japanese name candidates in KANJI, based on the romanized name ex. Yamamoto Sanae - and a known gender.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.japanese_name_kanji_candidates_with_http_info(japanese_surname_latin, japanese_given_name_latin, known_gender, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['japanese_surname_latin', 'japanese_given_name_latin', 'known_gender']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('known_gender' not in local_var_params or
            ...
            raise ValueError("Missing the required parameter `known_gender` when calling `japanese_name_kanji_candidates`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='NameMatchCandidatesOut',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
    ...
    def japanese_name_kanji_candidates1(self, japanese_surname_latin, japanese_given_name_latin, **kwargs):  # noqa: E501
        """Identify japanese name candidates in KANJI, based on the romanized name ex. Yamamoto Sanae  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.japanese_name_kanji_candidates1(japanese_surname_latin, japanese_given_name_latin, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.japanese_name_kanji_candidates1_with_http_info(japanese_surname_latin, japanese_given_name_latin, **kwargs)  # noqa: E501
        else:
            (data) = self.japanese_name_kanji_candidates1_with_http_info(japanese_surname_latin, japanese_given_name_latin, **kwargs)  # noqa: E501
            return data

    def japanese_name_kanji_candidates1_with_http_info(self, japanese_surname_latin, japanese_given_name_latin, **kwargs):  # noqa: E501
        """Identify japanese name candidates in KANJI, based on the romanized name ex. Yamamoto Sanae  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.japanese_name_kanji_candidates1_with_http_info(japanese_surname_latin, japanese_given_name_latin, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method japanese_name_kanji_candidates1" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'japanese_surname_latin' is set
        if ('japanese_surname_latin' not in local_var_params or
                local_var_params['japanese_surname_latin'] is None):
            raise ValueError("Missing the required parameter `japanese_surname_latin` when calling `japanese_name_kanji_candidates1`")  # noqa: E501
        # verify the required parameter 'japanese_given_name_latin' is set
        if ('japanese_given_name_latin' not in local_var_params or
                local_var_params['japanese_given_name_latin'] is None):
            raise ValueError("Missing the required parameter `japanese_given_name_latin` when calling `japanese_name_kanji_candidates1`")  # noqa: E501
    ...
    def japanese_name_match_with_http_info(self, japanese_surname_latin, japanese_given_name_latin, japanese_name, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='NameMatchedOut',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
    ...
    def japanese_name_match_batch(self, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param BatchMatchPersonalFirstLastNameIn batch_match_personal_first_last_name_in: A list of personal Japanese names in LATIN, firstName = japaneseGivenName; lastName=japaneseSurname
    ...
    def japanese_name_match_batch_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['batch_match_personal_first_last_name_in']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        body_params = None
        if 'batch_match_personal_first_last_name_in' in local_var_params:
            body_params = local_var_params['batch_match_personal_first_last_name_in']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='BatchNameMatchedOut',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
    ...
    def japanese_name_match_feedback_loop_with_http_info(self, japanese_surname_latin, japanese_given_name_latin, japanese_name, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='FeedbackLoopOut',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
