...
class JapaneseApi(object):
    ...
    def japanese_name_kanji_candidates1(self, japanese_surname_latin, japanese_given_name_latin, known_gender, **kwargs):  # noqa: E501
        """Identify japanese name candidates in KANJI, based on the romanized name ex. Yamamoto Sanae - and a known gender.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.japanese_name_kanji_candidates1(japanese_surname_latin, japanese_given_name_latin, known_gender, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.japanese_name_kanji_candidates1_with_http_info(japanese_surname_latin, japanese_given_name_latin, known_gender, **kwargs)  # noqa: E501
        else:
            (data) = self.japanese_name_kanji_candidates1_with_http_info(japanese_surname_latin, japanese_given_name_latin, known_gender, **kwargs)  # noqa: E501
            return data

    def japanese_name_kanji_candidates1_with_http_info(self, japanese_surname_latin, japanese_given_name_latin, known_gender, **kwargs):  # noqa: E501
        """Identify japanese name candidates in KANJI, based on the romanized name ex. Yamamoto Sanae - and a known gender.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.japanese_name_kanji_candidates1_with_http_info(japanese_surname_latin, japanese_given_name_latin, known_gender, async_req=True)
        >>> result = thread.get()
        ...
        if ('known_gender' not in local_var_params or
            ...
            raise ValueError("Missing the required parameter `known_gender` when calling `japanese_name_kanji_candidates1`")  # noqa: E501
