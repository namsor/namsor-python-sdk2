...
class AdminApi(object):
    ...
    def learnable(self, source, learnable, token, **kwargs):  # noqa: E501
        """Activate/deactivate learning from a source.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.learnable(source, learnable, token, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.learnable_with_http_info(source, learnable, token, **kwargs)  # noqa: E501
        else:
            (data) = self.learnable_with_http_info(source, learnable, token, **kwargs)  # noqa: E501
            return data

    def learnable_with_http_info(self, source, learnable, token, **kwargs):  # noqa: E501
        """Activate/deactivate learning from a source.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.learnable_with_http_info(source, learnable, token, async_req=True)
        >>> result = thread.get()
        ...
        if ('token' not in local_var_params or
                local_var_params['token'] is None):
            raise ValueError("Missing the required parameter `token` when calling `learnable`")  # noqa: E501
    ...
    def regions(self, **kwargs):  # noqa: E501
        """Print basic source statistics.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.regions(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.regions_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.regions_with_http_info(**kwargs)  # noqa: E501
            return data

    def regions_with_http_info(self, **kwargs):  # noqa: E501
        """Print basic source statistics.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.regions_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='RegionOut',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
