...
class PersonalNameParsedOut(object):
    ...
    def __init__(self, script=None, id=None, explanation=None, name=None, name_parser_type=None, name_parser_type_alt=None, first_last_name=None, score=None):  # noqa: E501
    ...
    @property
    def script(self):
        """Gets the script of this PersonalNameParsedOut.  # noqa: E501


        :return: The script of this PersonalNameParsedOut.  # noqa: E501
        :rtype: str
        """
        return self._script
    ...
    def script(self, script):
        ...
        :param script: The script of this PersonalNameParsedOut.  # noqa: E501
        :type: str
        """
    ...
    def explanation(self):
        """Gets the explanation of this PersonalNameParsedOut.  # noqa: E501


        :return: The explanation of this PersonalNameParsedOut.  # noqa: E501
        :rtype: str
        """
    ...
    def explanation(self, explanation):
        """Sets the explanation of this PersonalNameParsedOut.


        :param explanation: The explanation of this PersonalNameParsedOut.  # noqa: E501
        :type: str
        """
    ...
    def name_parser_type(self):
        ...
        Name parsing is addressed as a classification problem, for example FN1LN1 means a first then last name order.  # noqa: E501
    ...
    def name_parser_type(self, name_parser_type):
        ...
        if name_parser_type not in allowed_values:
            raise ValueError(
                "Invalid value for `name_parser_type` ({0}), must be one of {1}"  # noqa: E501
    ...
    def name_parser_type_alt(self):
        ...
        Second best alternative parsing. Name parsing is addressed as a classification problem, for example FN1LN1 means a first then last name order.  # noqa: E501
    ...
    def name_parser_type_alt(self, name_parser_type_alt):
        ...
        if name_parser_type_alt not in allowed_values:
            raise ValueError(
                "Invalid value for `name_parser_type_alt` ({0}), must be one of {1}"  # noqa: E501
