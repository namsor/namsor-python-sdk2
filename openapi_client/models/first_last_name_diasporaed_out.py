...
class FirstLastNameDiasporaedOut(object):
    ...
    def __init__(self, script=None, id=None, first_name=None, last_name=None, score=None, ethnicity_alt=None, ethnicity=None, lifted=None, country_iso2=None, ethnicities_top=None):  # noqa: E501
