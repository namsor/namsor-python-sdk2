...
class CorridorOut(object):
    ...
    def __init__(self, id=None, first_last_name_gendered_out=None, first_last_name_origined_out=None, first_last_name_diasporaed_out=None, script=None):  # noqa: E501
