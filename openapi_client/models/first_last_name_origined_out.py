...
class FirstLastNameOriginedOut(object):
    ...
    def __init__(self, id=None, first_name=None, last_name=None, country_origin=None, country_origin_alt=None, score=None, region_origin=None, top_region_origin=None, sub_region_origin=None):  # noqa: E501
