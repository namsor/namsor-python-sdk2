...
# body param
SchemaForRequestBodyApplicationJson = BatchNameIn


request_body_batch_name_in = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _name_type_batch_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_batch_name_in.serialize(body, content_type)
...
class NameTypeBatch(BaseApi):
    ...
    def name_type_batch(
        ...
        return self._name_type_batch_oapg(
            body=body,
