...
# body param
SchemaForRequestBodyApplicationJson = BatchFirstLastNamePhoneNumberIn


request_body_batch_first_last_name_phone_number_in = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _phone_code_batch_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_batch_first_last_name_phone_number_in.serialize(body, content_type)
...
class PhoneCodeBatch(BaseApi):
    ...
    def phone_code_batch(
        ...
        return self._phone_code_batch_oapg(
            body=body,
