...
SchemaFor200ResponseBodyApplicationJson = BatchPersonalNameReligionedOut
...
class BaseApi(api_client.Api):
    @typing.overload
    def _religion_indian_full_batch_oapg(
        self,
...
class ReligionIndianFullBatch(BaseApi):
    ...
    def religion_indian_full_batch(
        ...
        return self._religion_indian_full_batch_oapg(
            body=body,
