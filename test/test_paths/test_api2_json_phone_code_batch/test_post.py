...
from openapi_client.paths.api2_json_phone_code_batch import post  # noqa: E501
from openapi_client import configuration, schemas, api_client

from .. import ApiTestMixin


class TestApi2JsonPhoneCodeBatch(ApiTestMixin, unittest.TestCase):
    """
    Api2JsonPhoneCodeBatch unit test stubs
