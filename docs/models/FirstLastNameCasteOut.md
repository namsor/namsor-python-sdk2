# openapi_client.model.first_last_name_caste_out.FirstLastNameCasteOut
...
------------ | ------------- | ------------- | -------------
dict, frozendict.frozendict,  | frozendict.frozendict,  | Represents the output of inferring the LIKELY caste from a personal Hindu/Indian name. | 
...
**caste** | str,  | str,  | Most likely caste | [optional] 
**casteAlt** | str,  | str,  | Second best alternative : caste | [optional] 
**[casteTop](#casteTop)** | list, tuple,  | tuple,  | List caste(top 10) | [optional] 
...
Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | -------------
list, tuple,  | tuple,  | List caste(top 10) | 

### Tuple Items
Class Name | Input Type | Accessed Type | Description | Notes
------------- | ------------- | ------------- | ------------- | -------------
items | str,  | str,  | List caste(top 10) | 
